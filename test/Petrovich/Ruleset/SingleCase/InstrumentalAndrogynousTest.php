<?php
namespace BoShurik\Petrovich\Test\Petrovich\Ruleset\SingleCase;

use BoShurik\Petrovich\Test\Petrovich\Ruleset\SingleCaseHelper;

use BoShurik\Petrovich\Petrovich\Ruleset;

class InstrumentalAndrogynousTest extends SingleCaseHelper
{
